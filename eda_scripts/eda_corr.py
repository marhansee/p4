...
# 5) Identify numeric columns (exclude Timestamp)
numeric_cols = [
...
# 6) Drop rows with nulls in any numeric column
...
# 7) Assemble into feature vector
...
# 9) Plot and save (instead of show)
