...
class CNN_LSTM(nn.Module):
    def __init__(self, input_size, out_channels=64, hidden_size=64, num_layers=2, num_classes=2):
        super(CNN_LSTM, self).__init__()
        self.cnn = nn.Sequential(
            nn.Conv1d(in_channels=input_size, out_channels=out_channels, 
...
def main():
    ...
    model = CNN_LSTM(input_size=n_features, out_channels=out_channel)
